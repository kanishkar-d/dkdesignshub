...
export default function WeDidModal({ isOpen, onClose, onOpenContact }) {
  const works = [
    ...
    {
      id: 5,
      title: "Creative Studio Digital Solutions",
      category: "Web Development & Digital Branding",
      tagline: "We Build Digital Solutions for Your Business",
      image: "/works/work5_creative_studio.jpg",
      description: "Full-service digital agency website UI featuring modern layout, interactive portfolio showcases, client reviews, and lead capture system."
    },
    {
      id: 6,
      title: "Medicare Clinic Portal",
      category: "Medical Web Portal & Booking System",
      tagline: "Your Health, Our Priority",
      image: "/works/work6_medicare_clinic.png",
      description: "Clean medical portal web interface featuring instant doctor appointment scheduling, emergency support helpline, specialist profiles, and patient reviews."
    },
    {
      id: 7,
      title: "EduLearn EdTech Platform",
      category: "Online Education & Course Directory",
      tagline: "Build Your Bright Future",
      image: "/works/work7_edulearn.png",
      description: "Interactive e-learning directory with course search, featured categories, instructor profiles, pricing options, and quick enrollment CTA."
    },
    {
      id: 8,
      title: "ÉLANE Fine Dining",
      category: "Luxury Hospitality & Restaurant UI",
      tagline: "Delicious Food, Good Mood — Beautifully Crafted",
      image: "/works/work8_elane_restaurant.jpg",
      description: "Atmospheric dark-themed restaurant website featuring signature dish displays, online table reservations, guest testimonials, and ambient culinary imagery."
    },
    {
      id: 9,
      title: "Bizify SaaS Business Software",
      category: "SaaS Dashboard & Business Platform",
      tagline: "Smart Software for Your Business",
      image: "/works/work9_bizify_software.png",
      description: "Modern SaaS product platform complete with real-time analytics dashboard view, tiered pricing plans, feature matrix, and trial signup flow."
    }
  ];
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-white/10 z-20">
          <div className="flex items-center gap-3">
            <span className="text-xs font-mono text-muted-foreground">
              Work <strong className="text-white">{String(activeIndex + 1).padStart(2, '0')}</strong> / {String(works.length).padStart(2, '0')}
            </span>
            <button
